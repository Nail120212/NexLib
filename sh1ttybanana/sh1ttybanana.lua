...
function Library:NewWindow(ConfigWindow)
    ...
    function Tab:T(nameOrConfig, iconName)
        ...
        TabDisable.Size = UDim2.new(1, 0, 0, 34)
        ...
        Choose_2.Position = UDim2.new(0, 0, 0, 9)
        Choose_2.Size = UDim2.new(0, 3, 0, 16)
        ...
        function TabFunc:AddSection(RealNameSection)
            ...
            function SectionFunc:AddColorpicker(cfcolor)
                ...
                ColorBtn.MouseButton1Click:Connect(function()
                    ...
                    Hue.Position = UDim2.new(0, 16, 0, 16)
                    Hue.Size = UDim2.new(1, -32, 0, 120)
                    ...
                    Preview.Position = UDim2.new(0, 16, 0, 148)
                    ...
                    Apply.Position = UDim2.new(1, -110, 1, -42)
                    Apply.Size = UDim2.new(0, 94, 0, 28)
                    ...
                    Cancel.Parent = Popup
                    Cancel.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
                    Cancel.BorderSizePixel = 0
                    Cancel.Position = UDim2.new(1, -210, 1, -42)
                    ...
                    Hue.InputBegan:Connect(function(input)
                        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                            local rel = math.clamp((input.Position.X - Hue.AbsolutePosition.X) / Hue.AbsoluteSize.X, 0, 1)
                            local c = Color3.fromHSV(rel, 0.9, 1)
