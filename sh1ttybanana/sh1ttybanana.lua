...
function Library:NewWindow(ConfigWindow)
    ...
    UptimeTile.Position = UDim2.new(0, 14, 0, 136)
    UptimeTile.Size = UDim2.new(1, -28, 0, 62)
    ...
    HwidTile.Position = UDim2.new(0, 14, 0, 206)
    HwidTile.Size = UDim2.new(1, -28, 0, 48)
    HwidTile.ZIndex = 112
    ...
    CardFooter.Position = UDim2.new(0, 14, 1, -28)
