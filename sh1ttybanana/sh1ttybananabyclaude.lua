...
function Library:NewWindow(ConfigWindow)
    ...
    ResizeH.Size = UDim2.new(0, 18, 0, 4)
    ResizeH.ZIndex = 16
    Library:Themed(ResizeH, "BackgroundColor3", "Accent")
    Library:Corner(ResizeH, UDim.new(1, 0))
    ...
    ResizeV.Size = UDim2.new(0, 4, 0, 18)
    ResizeV.ZIndex = 16
    Library:Themed(ResizeV, "BackgroundColor3", "Accent")
    Library:Corner(ResizeV, UDim.new(1, 0))

    do
        local Resizing = false
        local StartPos, StartSize
        local MinW, MinH = 470, 320

        ResizeHandle.MouseEnter:Connect(function()
            Library:TweenInstance(ResizeH, 0.15, "BackgroundTransparency", 0)
            Library:TweenInstance(ResizeV, 0.15, "BackgroundTransparency", 0)
        end)
        ...
        ResizeHandle.MouseLeave:Connect(function()
            ...
            Library:TweenInstance(ResizeH, 0.15, "BackgroundTransparency", 0.35)
            Library:TweenInstance(ResizeV, 0.15, "BackgroundTransparency", 0.35)
        end)
        ...
        UserInputService.InputChanged:Connect(function(Input)
            ...
            if Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch then
                ...
                DropShadowHolder.Size = UDim2.new(0, math.max(MinW, StartSize.X + DeltaX), 0, math.max(MinH, StartSize.Y + DeltaY))
            end
        end)
    end
    ...
    AIWindow.Size = UDim2.new(0, 430, 0, 496)
    ...
    AIMessages.Size = UDim2.new(1, 0, 1, -167)
    ...
    AISuggestions.Position = UDim2.new(0, 14, 1, -100)
    AISuggestions.Size = UDim2.new(1, -28, 0, 28)
    ...
    AIInputFrame.Position = UDim2.new(0, 14, 1, -14)
    AIInputFrame.Size = UDim2.new(1, -28, 0, 46)
    ...
    Library:MakeDraggable(AIHeader, AIWindow)
    ...
    local function AddBubble(Role, Text, Refs)
        ...
        HolderList.Padding = UDim.new(0, 7)
        ...
        Bubble.Size = UDim2.new(Role == "user" and 0.82 or 0.92, 0, 0, 0)
    ...
    PlayerCard.AnchorPoint = Vector2.new(0.5, 0.5)
    PlayerCard.BackgroundTransparency = 0.02
    PlayerCard.BorderSizePixel = 0
    PlayerCard.Position = UDim2.new(0.5, 0, 0.5, 0)
    PlayerCard.Size = UDim2.new(0, 336, 0, 492)
    ...
    AvatarRing.Parent = PlayerCard
    AvatarRing.BackgroundTransparency = 0
    AvatarRing.BorderSizePixel = 0
    AvatarRing.Position = UDim2.new(0, 16, 0, 44)
    AvatarRing.Size = UDim2.new(0, 82, 0, 82)
    ...
    DisplayLabel.Position = UDim2.new(0, 108, 0, 52)
    DisplayLabel.Size = UDim2.new(1, -160, 0, 22)
    ...
    UserLabel.Position = UDim2.new(0, 108, 0, 73)
    UserLabel.Size = UDim2.new(1, -160, 0, 16)
    ...
    CardDivider.Parent = PlayerCard
    CardDivider.BorderSizePixel = 0
    CardDivider.Position = UDim2.new(0, 16, 0, 136)
    ...
    UptimeTile.Parent = PlayerCard
    UptimeTile.BackgroundTransparency = 0.94
    UptimeTile.BorderSizePixel = 0
    UptimeTile.Position = UDim2.new(0, 16, 0, 150)
    UptimeTile.Size = UDim2.new(1, -32, 0, 62)
    ...
    HwidTile.Parent = PlayerCard
    HwidTile.BackgroundTransparency = 0.94
    HwidTile.BorderSizePixel = 0
    HwidTile.Position = UDim2.new(0, 16, 0, 220)
    HwidTile.Size = UDim2.new(1, -32, 0, 48)
    HwidTile.ZIndex = 112
    ...
    StatGrid.Position = UDim2.new(0, 16, 0, 278)
    StatGrid.Size = UDim2.new(1, -32, 0, 174)
    StatGrid.ZIndex = 112
    ...
    CardFooter.Parent = PlayerCard
    CardFooter.BackgroundTransparency = 1
    CardFooter.Position = UDim2.new(0, 16, 1, -28)
    CardFooter.Size = UDim2.new(1, -66, 0, 18)
    ...
    CardRefresh.Parent = PlayerCard
    CardRefresh.AnchorPoint = Vector2.new(1, 1)
    CardRefresh.BackgroundTransparency = 0.9
    CardRefresh.BorderSizePixel = 0
    CardRefresh.Position = UDim2.new(1, -16, 1, -14)
    ...
    Library:MakeDraggable(CardBanner, PlayerCard)
    ...
    function WindowAPI:Tag(cfg)
        ...
        if not TagHolder then
            ...
            TagHolder.Position = UDim2.new(0, 324, 0.5, 0)
            TagHolder.Size = UDim2.new(1, -500, 0, 22)
