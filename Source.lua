...
local Library do
    ...
    Library = {
        ...
        Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nail120212/NexLib/refs/heads/main/Icons/lucide.lua"))(),
    ...
    do -- Elements
        ...
        Library.Window = function(self, Data)
            ...
            local function NormalizeImage(img)
                ...
                if StringFind(s, "rbxassetid://") then return s end
                return "rbxassetid://" .. s
            end

            local Window = {
                Name = Data.Name or Data.Title or Data.name or Data.title or "Window",
                Subtitle = Data.Subtitle or Data.subtitle or nil,
                IconImage = NormalizeImage(Data.IconImage or Data.iconimage),
            ...
            local Items = { } do
                Items["MainFrame"] = Instances:Create("Frame", {
                    ...
                    ClipsDescendants = true,
                                        ZIndex = 1,
                    Size = Window.Size and UDim2New(0, Window.Size.X or 575, 0, Window.Size.Y or 345) or UDim2New(0, 575, 0, 345),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(15, 14, 18)
                ...
                if Window.IconImage then
                    Items["TitleIcon"] = Instances:Create("ImageLabel", {
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(255, 255, 255)
                    })  Items["TitleIcon"]:AddToTheme({ImageColor3 = "Image"})
                end
                Items["Title"] = Instances:Create("TextLabel", {
                    Parent = Items["TitleContainer"].Instance,
                    Name = "\0",
                ...
                if IsMobile then
                    Items["FloatingButton"] = Instances:Create("ImageButton", {
                        ...
                        Active = false,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Image = Window.IconImage or "rbxassetid://127120679730794",
                        AutoButtonColor = false,
                        ...
                        BorderSizePixel = 0,
                        BackgroundColor3 = FromRGB(26, 24, 31)
                    })  Items["FloatingButton"]:AddToTheme({BackgroundColor3 = "Inline"})
                    ...
                    Items["FloatingButton"].Instance.Visible = true
            ...
            function Window:Minimize(Bool)
                ...
                if IsMinimized then
                    ...
                    Items["MainFrame"]:Tween(nil, {Size = UDim2New(0, Items["TitleContainer"].Instance.AbsoluteSize.X + 110, 0, 40)})
        ...
        Library.Sections.Row = function(self, Data)
            Data = Data or { }
            local Row = {
                Window = self.Window,
                Page = self.Page,
            ...
            Row.Items["Content"] = RowFrame
            return setmetatable(Row, Library.Sections)
        end
