...
local function loadHub()
    ...
    PlayersTab:AddParagraph({
        Title = "Info",
        Content = "Drag bottom center line only. Resize bottom-right. ToggleKey = RightControl. Key = Banana",
        Position = "left"
    })
    ...
    Misc:AddParagraph({
        Title = "Controls",
        Content = "Bottom center line = drag. Bottom-right = resize. Logo = open/close. Key placeholder/key = Banana",
        Position = "left"
    })
